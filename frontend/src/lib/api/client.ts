	...
	if (USE_MOCK) {
		return {
			models: [
				...
				{ id: 'openai/gpt-5.4', display_name: 'GPT-5.4', provider: 'openrouter', tier: 'paid', is_default: true, description: 'OpenAI flagship model', context_length: 131072, prompt_price: '0.000002', completion_price: '0.000008' },
