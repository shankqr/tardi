...
<div class="relative rounded-2xl border border-gray-900 dark:border-gray-100 shadow-lg p-8 flex flex-col">
	<div>
		<h3 class="text-lg font-semibold text-gray-900 dark:text-white">{plan.name}</h3>
		<p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Everything you need to run your AI agent</p>
	</div>
	<div class="mt-4">
	...
	<a
		href="/signup"
		class="mt-8 block rounded-lg bg-gray-900 dark:bg-white px-4 py-2.5 text-center text-sm font-medium text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-100"
	>
		Get Started
	</a>
</div>
