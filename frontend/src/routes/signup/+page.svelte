<script lang="ts">
	...
	import { signUp, signInWithGoogle, authError } from '$lib/stores/auth';
	...
	<div class="w-full max-w-md">
		...
		<div class="mt-6">
			...
			<button
				...
				disabled={submitting}
				class="mt-4 flex w-full items-center justify-center gap-2 rounded-lg border border-gray-300 px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50"
			>
